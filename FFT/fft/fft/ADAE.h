...
* 历史记录 :
* 版本   日期        作者        内容
* V1.0   2008-11-14  buxj        创建
* V1.1   2009-05-19  buxj        修订，添加IN、OUT、INOUT定义
* V1.2   2009-07-28  buxj        修订，去除ADAE命名空间定义，以
                                 适用C语言环境。
* V1.3   2009-08-18  buxj        添加ADAE_TIME_VALUE结构体定义
* V1.4   2009-11-27  buxj        整理类型定义
* V1.5   2010-01-26  buxj        重新定义类型，部分类型放在smee.h中
***************************************************************/
#ifndef __ADAE_H__
#define __ADAE_H__
...
//file access flag--include IPC(sharememory、semaphore)、file *include normal file、searial file、socket etc 
#define ADAE_RD         0x00
#define ADAE_WR         0x01
...
/*********************************************function lists for global************************************************/

//调试用，再SMEE_DEBUG模式开启的情况下启用
SMEE_EXPORT void ADAE_debug(const char* format_msg,...);
//常用的日志记录，所记日志记入日志文件中
SMEE_EXPORT void ADAE_logging(int error_code,const char* file_name,int line,const char* format_msg,...);
